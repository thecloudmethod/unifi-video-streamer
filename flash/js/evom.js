...
function parseData(e) {
	switch (e[0]) {
	case p:
		console.log(e[0] + ' = case p'),
		F.g = !0,
		u(e[0]);
		break;
	case w:
		console.log(e[0] + ' = case w');
		var i = e[4];
...
function stopPlayer(e) {
	M && (S.pause(), "undefined" == typeof e && (e = !1), e || (S.poster = "evo.png", I = null), feedFragment(254), O = [], B = null, S = null, E = null, M = !1, L = 0, A = !1, z = 0, C = 0)
}
function l(e) {
